...
t1 = dt(2018, 1, 1, 9,0,0)
t2 = dt(2018, 1, 11, 17,30,0)
print(t2)
#b = BusinessHours(datetime('2018-01-01 09:00:00'), datetime('2018-01-10 09:00:00'), worktiming=[9, 17])
b = BusinessHours(t1, t2, worktiming=[9, 17])
time = b.gethours()
print(time/8)
